...
- What are we planning to talk about : <br/> <br/>
  a) General and Generalized linear models <br/>
  b) Mixed-effects models: cross-sectional and longitudinal data <br/>
  c) Structural equation modelling: path models and confirmatory factor analysis<br/> <br/>
see Handbook on Blackboard <br/>
...
b) Commented R code
([link](https://nvaci.github.io//PSY6210-RCode//RCode.html) for this lecture)<br/>
c) Course glossary: [link](https://nvaci.github.io/PSY6210-Glossary/PSY6210---Glossary.html)
???
...
Feedback form and questions: [Q&A sheet](https://docs.google.com/spreadsheets/d/1tpoRAAZDtIQP0T1IRVtWNE4fcplEvwHPKVg4crH0220/edit?gid=0#gid=0) <br/>

Course communication: n.vaci@sheffield.ac.uk <br/>
Office hours: Thursday from 2 to 3 pm (https://shorturl.at/yUzhv)<br/>
...
Each regressor gets a weight/coefficient that is used to estimate Y. This coefficient is estimated according to some criteria, eg. minimises the sum of squared errors or maximises the logarithm of the likelihood function. Additional reading: <br/> [Estimation of the parameters](https://strimmerlab.github.io/publications/lecture-notes/MATH20802/estimating-regression-coefficients.html) 
<br/><br/>
...
```{r, echo=F, fig.width=11, fig.height=5, fig.align='center', warning=FALSE, message=FALSE}
require(ggplot2)
...
<iframe allowfullscreen frameborder="0" height="80%" mozallowfullscreen src="https://app.wooclap.com/MEFZJS/questionnaires/6978a9bf40e6069a578179af" style="min-height: 550px; min-width: 300px" width="100%"></iframe>
